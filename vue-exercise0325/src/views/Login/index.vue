		...
		<div class="form-container">
			<el-form :model="userForm" ref="userForm" :rules="rules" label-width="100px">
				...
				<el-form-item label="手机号" prop="phoneNo">
					<el-input type="text" v-model="userForm.phoneNo" autocomplete="false"></el-input>
				</el-form-item>
	...
	methods: {
		...
		submitUserForm(formname) {
			const submitFn = _ => {
				...
				setTimeout(() => {
					this.$store.dispatch('user/setUserInfo', { userName: this.userForm.account, phoneNo: this.userForm.phoneNo });
					this.loading.close();
					// alert('提交成功');
					this.$router.push({
						path: '/news'
